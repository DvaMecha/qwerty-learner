    ...
    <Layout>
      <Header>
        <Tooltip content="快捷键 Enter or Esc">
          <NavLink className="rounded-lg bg-cyan-400 px-6 py-1 text-lg text-white focus:outline-none dark:text-opacity-80" to="/">
            完成选择
          </NavLink>
        </Tooltip>
      </Header>
      <div className="mb-auto mt-auto flex w-auto space-x-4 overflow-y-auto">
        <div className="flex flex-col space-y-2 overflow-y-auto rounded-lg bg-cyan-50 p-6 dark:bg-slate-800">
        ...
        <div className="flex flex-col overflow-y-auto rounded-lg bg-cyan-50 p-6 dark:bg-slate-800">
