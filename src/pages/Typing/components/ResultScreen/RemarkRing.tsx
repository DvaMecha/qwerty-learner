  ...
  return (
    <div
      className={classNames(
        'relative flex flex-shrink-0 flex-col items-center justify-center rounded-full border-8 border-cyan-200 bg-transparent dark:border-gray-700',
      )}
      style={{
        width: `${size}rem`,
        height: `${size}rem`,
    ...
    >
      {percentage !== null && (
        <div
          className="absolute -inset-2 rounded-full border-8 border-cyan-400 bg-transparent dark:border-cyan-500"
          style={{ clipPath }}
          aria-hidden
        />
      )}
