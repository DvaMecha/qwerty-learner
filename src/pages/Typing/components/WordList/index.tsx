    ...
    <>
      <Tooltip content="List" placement="top" className="!absolute left-5 top-[50%] z-20">
        <button
          type="button"
          onClick={openModal}
          className="fixed left-0 top-[50%] z-20 rounded-lg rounded-l-none bg-cyan-50 px-2 py-3 text-lg hover:bg-cyan-200 focus:outline-none dark:bg-cyan-900 dark:hover:bg-cyan-800"
        >
          <ListIcon className="h-6 w-6 text-lg text-cyan-500 dark:text-white" />
        </button>
      </Tooltip>
