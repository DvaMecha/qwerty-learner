        ...
        <div className={styles.tabContent}>
          <div className={styles.section}>
            ...
            <span className={styles.sectionDescription}>
              目前，用户的练习数据<strong>仅保存在本地</strong>。如果您需要在不同的设备、浏览器或者其他非官方部署上使用 Lucky Words，
            ...
            <div className="flex h-3 w-full items-center justify-start px-5">
              ...
              >
                <Progress.Indicator
                  className="cubic-bezier(0.65, 0, 0.35, 1) h-full w-full bg-cyan-400 transition-transform duration-500 ease-out"
