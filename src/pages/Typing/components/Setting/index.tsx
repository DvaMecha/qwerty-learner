  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className={`flex items-center justify-center rounded p-[2px] text-lg text-cyan-500 outline-none transition-colors duration-300 ease-in-out hover:bg-cyan-400 hover:text-white  ${
